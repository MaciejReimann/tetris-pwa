...
},{"./helpers/arrayHelpers":2,"./helpers/pointHelpers":4,"./helpers/tetrominoManipulation":7}],12:[function(require,module,exports){
...
},{"./helpers/setupGameboard":6,"./tetris":11}],13:[function(require,module,exports){
...
function render() {
  ...
  fill(CANVAS, "black");
  if (tetromino) {
    tetromino.map(square =>
      drawSquare(square, CANVAS, square[0].prop.color).fill()
    );
  }
  if (squares) {
    squares.map(square =>
